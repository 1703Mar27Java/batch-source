...
<body>
	...
	SELECT * FROM BANK_ACCOUNT WHERE USER_ID = 41
	</sql:query>
	 <table>
        <tr>
            <th>USER ID</th>
        ...
        <c:forEach var="row" items="${result.rows}">
            <tr>
                ...
                <td><c:out value="${row.BANK_ACCOUNTID }"/></td>
               ...
               <!--  <td><button type="submit" id=${row.USER_ID}>SELECT</button></td>-->
   				 ...
   				 <input type = "text" name="accID" placeholder="ENTER ACC ID" />
   				 <br></br>
				<input type="text" name="with" value = 0>
				<input type="submit" value="withdraw" name="withButton">
				<input type="text" name="dep" value = 0>
				<input type="submit" value="deposit" name="depButton">
