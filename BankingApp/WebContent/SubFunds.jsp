...
<body style="background-color: #d1d2d3">
	...
	<div class="container">
		<div align="center">
				...
				<div class="alert alert-danger">
					<strong>Whoops!</strong> BankID and money MUST be numeric.
				</div>
	...
	<form action="subFunds" method="post">
		...
		<div class="row">
			<div>Money to Remove: <input type="text" name="money"></div>
		</div>
		<div class="row">
				<input name="btn" type="submit" value="Remove Funds"
					class="btn btn-lg btn-primary" />
		</div>
	</form>

	<!-- Display Bank accounts per user -->
