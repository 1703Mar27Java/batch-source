...
public class Bank_User implements Cloneable, Serializable {
	...
	public Bank_User(String bANK_USER_NAME, String bANK_USER_PASSWORD) {
		super();
		BANK_USER_NAME = bANK_USER_NAME;
		BANK_USER_PASSWORD = bANK_USER_PASSWORD;
	}

	public Bank_User(int bANK_USER_ID, String bANK_USER_NAME, String bANK_USER_PASSWORD) {
		super();
