		...
		<TR>
			...
			<TABLE class = "banner">
   				<TR>
      				...
      				<TD id="bannerTitle"><img src="bank_Banner.png" alt="No graph... sorry" min-width = "90%"></TD>
      				<TD id="bannerImage"><img src="piggyBank.jpg" alt="No graph... sorry" min-width = "100" height = "100"></TD>
   				</TR>
			</TABLE>
			</TD>
		</TR>
					...
					<tr> 
						...
						<td>
							<form action="changeBalance" method="post">
								...
								<input class = "lbl" type="submit" value="Deposit" name="Deposit"/>
							</form>
						</td>
						<td>
							<form action="changeBalance" method="post">
  								<p class = "lbl">Withdrawal Amt:<input type="text" name="amount"><br></p> 
								<input class = "lbl" type="submit" value="Withdraw" name="Withdrawal"/>
							</form>
							</td>
					</tr>
					<tr>
