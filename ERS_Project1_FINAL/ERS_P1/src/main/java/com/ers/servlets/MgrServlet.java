...
import com.ers.dao.ManagersDAOImpl;
	...
	try{
		 ERSUtil n = new ERSUtil();
		  System.out.println("Connected to database: "+ n);
			 ...
			 ManagersDAOImpl dao = new ManagersDAOImpl();
			 ...
			 dao.createMgrAcct(new Managers(id,un, pw,fn, ln, em,urid,""));
		...
		/*	PrintWriter out = response.getWriter();
			...
			response.sendRedirect("MgrInfo.jsp"); 
