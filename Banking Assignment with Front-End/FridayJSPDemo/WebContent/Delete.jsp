...
<body>
	...
	<table border="1" bgcolor="#FFFFFF" align="center">
		<tr>
			<form method="post">
				...
				<td><a href="Deposit.jsp"> <input type="submit"></a></td>
			</form>
		</tr>
	</table>
	...
	<%
		...
		if (accountName != null) 
		{
			...
			{
				if (accountName.equals(banks.get(i).getBankName()) && banks.get(i).getBalance() == 0) 
				{
					bDao.deleteBankAccount(banks.get(i), loggedInUser);
				}
				else if(accountName.equals(banks.get(i).getBankName()) && banks.get(i).getBalance() != 0)
					out.println("You can't delete an account with money still in it.");
			}
		}
	%>
