...
<%--         </sql:query> --%>
	...
	<form method="post">
		...
		<a href="LoginUser.jsp"> <input type="submit">
		</a>
	</form>
	<%
		...
		if (username != null & password != null) {
			...
			if(uDao.loginUser(newuser)==false)
			...
			else
			{
				...
				if(newuser.getSuperUser() == false)
				request.getRequestDispatcher("LoggedIn.jsp").forward(request, response);
				else
					request.getRequestDispatcher("SuperLoggedIn.jsp").forward(request, response);
			}
		}
